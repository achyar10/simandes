                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <select id="is_active" name="is_active"
                                ...
                                <option value="1" {{ $row->is_active ? 'selected' : null }}>Aktif</option>
                                <option value="0" {{ !$row->is_active ? 'selected' : null }}>Tidak Aktif</option>
                            </select>
                            @error('is_active')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <img id="target" src="{{ asset("$uri/$row->image") }}"
                                    alt="no image" class="img-thumbnail" style="height: 250px; width: 100%">
                            @endif
