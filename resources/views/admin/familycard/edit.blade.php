...
@section('title', 'Ubah Kartu Keluarga (KK)')
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ url("admin/familycard/$familycard->id") }}" method="post">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text" name="number" class="form-control @error('number') is-invalid @enderror"
                                value="{{ old('number', $familycard->number) }}" readonly>
                            @error('number')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="head_of_family"
                                ...
                                value="{{ old('head_of_family', $familycard->head_of_family) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" class="form-control">{{ old('address', $familycard->address) }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Kode Pos</label>
                            <input type="text" name="zip" class="form-control @error('zip') is-invalid @enderror"
                                value="{{ old('zip', $familycard->zip) }}">
                            @error('zip')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="print_date"
                                ...
                                value="{{ old('print_date', $familycard->print_date) }}">
                            @error('print_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
